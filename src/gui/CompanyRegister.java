...
public class CompanyRegister extends javax.swing.JFrame {
    ...
    public CompanyRegister(SupplierRegister parent) {
        initComponents();
        this.sr = parent;
    ...
    public void loadCompanies() {
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `company` INNER JOIN `city` ON `company`.`city_id`=`city`.`id` ORDER BY `company`.`id` ASC");
            ...
            while (rs.next()) {
                ...
                v.add(rs.getString(("company.contact_no")));
    ...
    private void initComponents() {
        ...
        setTitle("Echo - Company Registration");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Company Name", "Contact No", "City"
            }
        ) {
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    MySQL.iud("INSERT INTO `company`(`name`,`contact_no`,`city_id`) VALUES ('" + name + "','" + contact_number + "','"+city_id+"')");
                    ...
                    JOptionPane.showMessageDialog(this, "New Company Added Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(evt.getClickCount() == 2){
            ...
            if(r == -1){
                ...
                sr.jLabel4.setText(id);
                sr.jLabel5.setText(name);
                sr.jLabel7.setText(contact);
                sr.jLabel9.setText(city);
                sr.jButton3.setText("Update Company");
                this.dispose();
            }
        }
